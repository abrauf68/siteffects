    ...
    <div class="card-body pt-4">
        <form id="formSystemSettings" method="POST"
            ...
            <div class="row p-5">
                ...
                <div class="mb-4 col-md-12">
                    <label for="sidebar_text" class="form-label">{{ __('Sidebar Text') }}</label><span class="text-danger">*</span>
                    <input class="form-control @error('sidebar_text') is-invalid @enderror" type="text"
                        id="sidebar_text" name="sidebar_text"
                        value="{{ old('sidebar_text', $systemSetting->sidebar_text ?? '') }}"
                        placeholder="i.e. All CopyRights Reserved" required/>
                    @error('sidebar_text')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
