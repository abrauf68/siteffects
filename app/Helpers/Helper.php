...
class Helper
{
    ...
    {
        return CompanySetting::first()->phone_number ?? '+92 310 3792073';
    }
    ...
    {
        return CompanySetting::first()->instagram ?? 'https://www.instagram.com/siteffects';
    }

    public static function getCompanyLinkedin()
    {
        return CompanySetting::first()->linkedin ?? 'https://www.linkedin.com/in/siteffects';
    }

    public static function getCompanyTwitter()
    {
        return CompanySetting::first()->twitter ?? 'https://x.com/Siteffects1';
    }
    ...
    {
        return SystemSetting::first()->sidebar_text ?? env('APP_NAME');
    }
