                ...
                <div class="mb-4 col-md-12">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="instagram" name="instagram" class="form-control @error('instagram') is-invalid @enderror"
                            value="{{ $companySetting->instagram }}" placeholder="i.e. https://instagram.com/" />
                        @error('instagram')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="twitter" name="twitter" class="form-control @error('twitter') is-invalid @enderror"
                            value="{{ $companySetting->twitter }}" placeholder="i.e. https://x.com/" />
                        @error('twitter')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text"><i class="fab fa-tiktok fa-lg"></i></span>
