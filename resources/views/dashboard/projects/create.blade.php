            ...
            <div class="card-body pt-4">
                <form method="POST" action="{{ route('dashboard.projects.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row p-5">
                            ...
                            <select id="category" name="category" class="select2 form-select @error('category') is-invalid @enderror">
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category }}"
                                        {{ old($category) == $category ? 'selected' : '' }}>{{ ucfirst(str_replace('_', ' ', $category)) }}
                                    </option>
                                @endforeach
                            </select>
                            @error('category')
                        ...
                        <div class="mb-4 col-md-6">
                            <label for="scroll_image" class="form-label">{{ __('Scroll Image') }}</label><span
                                class="text-danger">*</span>
                            <input class="form-control @error('scroll_image') is-invalid @enderror" type="file"
                                id="scroll_image" name="scroll_image" required accept="image/*" />
                            @error('scroll_image')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                placeholder="{{ __('Enter description') }}" cols="30" rows="10"></textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <input class="form-control @error('meta_title') is-invalid @enderror" type="text"
                                ...
                                placeholder="{{ __('Enter meta title') }}" value="{{ old('meta_title') }}" />
                            @error('meta_title')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
