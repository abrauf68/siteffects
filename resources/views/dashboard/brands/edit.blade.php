        ...
        <div class="card mb-6">
            ...
            <div class="card-body pt-4">
                <form method="POST" action="{{ route('dashboard.brands.update', $brand->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row p-5">
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('name') is-invalid @enderror" type="text" id="name"
                                name="name" required placeholder="{{ __('Enter name') }}" autofocus value="{{old('name', $brand->name)}}"/>
                            @error('name')
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <div class="form-check">
                                <input class="form-check-input @error('is_featured') is-invalid @enderror" type="checkbox"
                                    name="is_featured" id="defaultCheck3" {{old('is_featured',$brand->is_featured == '1') ? 'checked' : ''}}>
                    ...
                    <div class="mt-2">
                        <button type="submit" class="btn btn-primary me-3">{{ __('Update Brand') }}</button>
                    </div>
                </form>
            </div>
            <!-- /Account -->
